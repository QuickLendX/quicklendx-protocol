 ...
 * backfillService.ts
 *
 * Manages the lifecycle of backfill runs that re-index historical on-chain
...
import { BackfillRun, BackfillRunStatus } from "../types/reconciliation";
...
export class BackfillService {
  ...
  public static resetInstance(): void {
    ...
    (BackfillService as any).instance = undefined;
  }
