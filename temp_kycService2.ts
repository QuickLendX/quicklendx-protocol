...
export const SENSITIVE_FIELDS = [
  ...
  "bankAccountNumber",
  "routingNumber",
  // snake_case (legacy API ΓÇö backward compatibility)
  "tax_id",
  "customer_name",
  "customer_address",
  "date_of_birth",
...
/** Loose payload type ΓÇö any JSON-serialisable object with a userId. */
...
/** Access log entry ΓÇö never contains key material or plaintext PII. */
...
export class KmsKeyProvider implements KeyProvider {
   ...
   * The caller-supplied `dek` is ignored ΓÇö KMS owns key generation.
...
export class KycService {
   ...
   * before returning ΓÇö raw values never leave this method.
   */
...
// ---------------------------------------------------------------------------
// Legacy API ΓÇö preserved for backward compatibility
// ---------------------------------------------------------------------------
