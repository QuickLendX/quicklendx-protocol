...
- [`docs/AUTH_MATRIX.md`](docs/AUTH_MATRIX.md): Source-grounded authorization matrix mapping exported contract entrypoints to required roles, signer checks, and state gates.
