...
- [`docs/PAUSE_TAXONOMY.md`](docs/PAUSE_TAXONOMY.md): Protocol pause taxonomy — complete matrix of pause reasons, circuit breaker modes, trigger conditions, affected entrypoints, and operational recovery guidance.
