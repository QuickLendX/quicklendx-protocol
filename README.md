...
- [`docs/INVOICE_LOCK.md`](docs/INVOICE_LOCK.md): Invoice lock duration, the two independent locking mechanisms (admin freeze vs. escrow hold), and auto-release behaviour — contributor-facing.
