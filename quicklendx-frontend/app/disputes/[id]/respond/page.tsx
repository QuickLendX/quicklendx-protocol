  ...
  const options = [
    {
      id: "agree_settle",
      label: "Agree & Settle",
      description: "Closes the dispute and triggers a refund.",
    },
    {
      id: "disagree_evidence",
      label: "Disagree & Provide Evidence",
      description: "Submit documents to support your case.",
    },
    {
      id: "request_info",
      label: "Request More Information",
      description: "Ask the investor for clarification.",
    },
    {
      id: "escalate",
      label: "Escalate to Mediator",
      description: "Request a neutral third-party review.",
    },
  ];
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-blue-700">
                          Your response will be visible to the investor
                          anonymously. Please ensure you do not include any
                          personally identifiable information (PII) in your
              ...
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2 text-sm text-gray-500">
                    ...
                    <p className="mt-2">
                      Once submitted, this response is immutable and will be
                      logged on-chain. It will be shared with the investor
                      anonymously.
                    </p>
                  </div>
                </div>
