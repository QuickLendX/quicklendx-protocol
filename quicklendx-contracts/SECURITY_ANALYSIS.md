...
_This analysis is based on property-based fuzz testing and should be complemented with manual security audit and formal verification for production deployment._
