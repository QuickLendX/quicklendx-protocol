...
use soroban_sdk::{testutils::Address as _, Address, BytesN, Env, IntoVal, String, TryFromVal,
    Val, Vec};
...
fn test_invoice_metadata_with_line_items() {
    ...
    items.push_back(LineItemRecord(String::from_str(&env, "Item 1"), 1, 100, 100));
