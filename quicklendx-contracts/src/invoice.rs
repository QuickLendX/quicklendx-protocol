...
impl InvoiceStorage {
    ...
    /// Get all invoice IDs for a given category
    ...
    /// Get invoice IDs for a given category filtered by status
    ...
    /// Get all invoice IDs for a given tag
    ...
    /// Get invoice IDs that match all supplied tags (AND logic)
