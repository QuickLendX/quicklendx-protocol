...
pub enum QuickLendXError {
    ...
    /// Identical (invoice_id, investor, salt) bid was already submitted.
    /// BREAKING: Do not renumber this variant. public ABI consumption.
    DuplicateBid = 2204,
    ...
    /// Settlement attempted with a malformed or unknown transaction hash
    InvalidTransactionHash = 2208,
}
...
impl From<QuickLendXError> for Symbol {
    fn from(error: QuickLendXError) -> Self {
        match error {
            ...
            QuickLendXError::InvalidTransactionHash => symbol_short!("INV_TX_H"),
        }
    }
}
