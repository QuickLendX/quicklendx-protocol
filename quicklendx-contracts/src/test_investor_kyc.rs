...
mod test_investor_kyc {
    ...
    fn setup() -> (Env, QuickLendXContractClient<'static>, Address) {
        ...
        // Initialize protocol limits (min invoice amount, max due date, grace period)
        let _ = client.try_initialize_protocol_limits(&admin, &1_000_000i128, &365u64, &86400u64);
        // Initialize protocol limits (min invoice: 1, max due date: 365 days, grace period: 86400s)
