...
fn create_base_invoice(
    env: &Env,
    client: &QuickLendXContractClient,
) -> (Address, soroban_sdk::BytesN<32>) {
...
fn test_update_metadata_success() {
    ...
    assert_eq!(
        invoice.metadata_tax_id,
        Some(String::from_str(&env, "TAX-12345"))
    );
}
...
fn test_update_metadata_non_owner_rejected() {
    ...
    env.mock_auths(&[soroban_sdk::testutils::MockAuth {
        ...
        invoke: &soroban_sdk::testutils::MockAuthInvoke {
            // Mocking any invoke for wrong user
...
fn test_validation_invalid_line_item_qty_price() {
    ...
    bad_items2.push_back(LineItemRecord(
...
fn test_validation_mismatched_computation() {
    ...
    bad_items.push_back(LineItemRecord(
        String::from_str(&env, "Item"),
        2,
        2000,
        5000,
